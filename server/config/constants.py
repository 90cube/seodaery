...
# --- 모델 식별자 ---
ROUTER_MODEL_NAME = os.getenv("ROUTER_MODEL_NAME", "bonsai-8b-1bit")
...
ROUTER_CTX_SIZE = int(os.getenv("ROUTER_CTX_SIZE", "4096"))
...
ROUTER_MODEL_FILE = os.getenv("ROUTER_MODEL_FILE", "Bonsai-8B.gguf")
